...
export const MY_WORKS: readonly MyWork[] = [
  {
    title: "個人サイト",
    description: "こちらのサイト。Astro.jsを用いて3日程度で制作。",
  ...
  },
  {
    ...
    description:
      "地方大学の研究室からの依頼で、DJIの産業用ドローンを用いた観測システムの開発と運用を行ない、3年目となる。3名のチームを構成し、観測機器の制作と視覚化ソフトを共同で制作したほか、SDKを利用しそれらを接続する組み込みプログラムや搭載したSBCのセットアップなどを担当。",
    url: "https://www.chunichi.co.jp/article/983433",
    linkTitle:
      "中日新聞掲載記事「越前市、上空ＣＯ２濃度観測　基準設け排出削減啓発へ　福井工大と連携　ドローン用いる」",
  ...
  },
  {
    ...
    description:
      "AWS Kinesis Video Streamから配信される動画ストリーミングをFlutterで制作したAndroidアプリに表示した。<br/>5人のチーム内で、主な画面の構成、認証、動画表示を担当したほか、技術選定やプロジェクト管理も支援した。",
    year: "2023",
  },
  {
    title: "地域イベントホームページ",
